...
Class IC_RNGWaitingRoom_GUI
{
    ...
    Init()
    {
        ...
        GUIFunctions.UseThemeTextColor()
        Gui, ICScriptHub:Add, Text, x+5 h%ctrlH% 0x200 vRNGWR_EllywickGFGemCardsText, Number of gem cards (set to 3 if you have Ellywick's Gem feat - or 2 if you do not)
        ; Redraws with ult
        GUIFunctions.UseThemeTextColor("InputBoxTextColor")
        Gui, ICScriptHub:Add, Edit, w40 xs y+%ySpacing% Limit3 vRNGWR_EllywickGFGemMaxRedraws gRNGWR_EllywickGFGemMaxRedraws
        GUIFunctions.UseThemeTextColor()
        Gui, ICScriptHub:Add, Text, x+5 h%ctrlH% 0x200 vRNGWR_EllywickGFGemMaxRedrawsText, Max redraws (set to 2 if you use Dungeon Master in Modron - or 1 if you do not)
        Gui, ICScriptHub:Add, CheckBox, xs y+%center% vRNGWR_EllywickGFGemWaitFor5Draws gRNGWR_EllywickGFGemWaitFor5Draws, Always wait for 5 draws (Enable if you hit a boss early. Early means before you get 5 cards.)
        ; Single draw
        GUIFunctions.UseThemeTextColor("HeaderTextColor", 700)
        Gui, ICScriptHub:Add, Groupbox, Section xs y+%ySpacing% vRNGWR_EllywickSingleGroup, On-Demand Card Drawing (NOT FOR USE WITH GEM FARMING)
        Loop, 5
        {
