...
[Navigate to the code repository for `IC Script Hub` in a browser](https://github.com/emmotes/ScriptHub/tree/main) and then click the green Code button. Pick `Download ZIP`.
